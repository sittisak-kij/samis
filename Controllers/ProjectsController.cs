...
namespace samis.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["locationTypeId"] = new SelectList(_context.LocationTypes, "locationTypeId", "locationTypeId");
        ...
        public async Task<IActionResult> Create([Bind("activityId,activityUnitId,referenceNumber,activityName,typeId,startDate,endDate,locationTypeId,venue,semester,year,participant,statusTypeId,advisorId")] ActivityInformation activityInformation)
        {
            ...
            ViewData["locationTypeId"] = new SelectList(_context.LocationTypes, "locationTypeId", "locationTypeId", activityInformation.locationTypeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("activityId,activityUnitId,referenceNumber,activityName,typeId,startDate,endDate,locationTypeId,venue,semester,year,participant,statusTypeId,advisorId")] ActivityInformation activityInformation)
        {
